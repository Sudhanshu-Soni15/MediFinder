...
if (isPost) {
  if (medicineName.isEmpty() || price.isEmpty() || stock.isEmpty()) {
    ...
    try {
      com.medifinder.dao.MedicineDAO medicineDAO = new com.medifinder.dao.MedicineDAO();
      boolean added = medicineDAO.addMedicine(
          pharmacyEmail, pharmacyName, medicineName,
